                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card contribution-card h-100">
                                <div class="card-body text-center d-flex flex-column">
                                    ...
                                    <p class="card-text text-muted flex-grow-1">
                                        Commit to contribute later and fulfill when convenient
                                    </p>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card contribution-card h-100">
                                <div class="card-body text-center d-flex flex-column">
                                    ...
                                    <p class="card-text text-muted flex-grow-1">
                                        Transfer directly to project bank accounts
                                    </p>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bankAccountsModalLabel">
                        <i class="fas fa-university me-2 text-success"></i> Project Bank Accounts
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    @forelse ($project->banks as $bank)
                    ...
                    @empty
                        <div class="alert alert-light border" role="alert">
                            <i class="fas fa-info-circle me-2"></i>
                            No bank accounts have been attached to this project yet.
                        </div>
                    @endforelse
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <a href="{{ route('contributions.confirm.form', ['type' => 'project', 'id' => $project->id]) }}"
                        class="btn btn-success">
                        <i class="fas fa-check-circle me-2"></i> I Have Sent My Contribution
                    </a>
                </div>
            </div>
        </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                amountInputs.forEach(input => {
                    input.addEventListener('input', function() {
                        if (this.value < 100) this.setCustomValidity('Minimum amount is ₦100');
                ...
                if (pledgeDate) pledgeDate.min = new Date().toISOString().split('T')[0];
            });
        </script>
    @endpush
@endsection
